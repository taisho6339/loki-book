...
![](<.gitbook/assets/スクリーンショット 2021-12-10 17.30.47.png>)
...
#### How to keep write-ahead logs

The write-ahead logs are written in Ingester's disk when it receives log post requests as mentioned previously.
